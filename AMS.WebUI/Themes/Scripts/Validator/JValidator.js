                ...
                case "default":
                    {
                        if (isNotNull($(this).attr("value"))) {
                            ...
                            Validateflag = false;
                            Tabchange($(this).parent().parent().parent().parent().parent().attr("id"));
                            $(".tab_list_top div").removeClass("actived");
                            $("#" + $(this).parent().parent().parent().parent().parent().attr("id").replace('tb_', '') + "Tab").addClass("actived"); //添加选中样式
...
function ChangeCss(obj, Validatemsg) {
    ...
    $(obj).focus(); //焦点
    $(obj.parent().parent().parent().parent().parent()).append('<table id="tipTable" class="tableTip"><tr><td  class="leftImage"></td> <td class="contenImage" align="left"></td> <td class="rightImage"></td></tr></table>');
