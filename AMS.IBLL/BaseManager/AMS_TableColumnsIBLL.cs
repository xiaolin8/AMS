...
namespace AMS.IBLL
{
    ...
    /// 模块列表表头定义 - 接口
    /// </summary>
    public interface AMS_TableColumnsIBLL
    {
        #region Method
        /// <summary>
        /// 获取最大编号
        ...
        /// <returns></returns>
        bool Insert(AMS_TableColumns entity);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        /// <param name="entity">实体类</param>
        /// <returns></returns>
        bool Update(AMS_TableColumns entity);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// <param name="KeyValue">主键</param>
        /// <returns></returns>
        AMS_TableColumns GetEntity(string KeyValue);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        /// <param name="MenuId">模块菜单主键</param>
        /// <returns></returns>
        IList GetList(string MenuId);
        /// <summary>
        /// 获得数据列表(带条件)
        /// </summary>
        ...
        /// <param name="MenuId">模块菜单主键</param>
        /// <returns></returns>
        bool BatchIsPublic(string[] KeyValue, string MenuId);
    }
}