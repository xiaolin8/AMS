...
namespace AMS.IBLL
{
    ...
    /// 用户、帐户 - 接口
    /// </summary>
    public interface BASE_USERIBLL
    {
        #region Method
        /// <summary>
        /// 获取记录总数
        ...
        /// <param name="KeyValue">主键</param>
        /// <returns></returns>
        BASE_USER GetEntity(string KeyValue);
        /// <summary>
        /// 获得数据列表
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        BASE_USER UserLogin(string Account, string Password, out string msg);
        /// <summary>
        /// 根据机构查询用户列表
        /// </summary>
